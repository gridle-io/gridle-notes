...
ToggleCreateCheckedNote(title,data){


  if(title || data.length){
    console.log(data);
  this.props.addnote(title,data,true);
  }
          ...
          <div>
              ...
              <div className="add-note">
                      <Paper 
                        ...
                        children={
                          <div className="add-note-data">
                            <h3 onClick={this.handleClick.bind(this)}>Take a note ...</h3>
                            <IconMenuAction handleChackedClick={this.handleChackedClick.bind(this)}/>
                          </div>} 
